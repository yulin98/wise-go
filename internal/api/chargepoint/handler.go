...
type Handler interface {
	CreateChargePoint() core.HandlerFunc

	DeleteChargePoint() core.HandlerFunc

	UpdateChargePoint() core.HandlerFunc

	QueryOneChargePoint() core.HandlerFunc

	QueryPageChargePoint() core.HandlerFunc
}
